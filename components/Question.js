...
class Question extends React.Component {
    ...
    updateQuestion = async () => {
        ...
        const token =
            "b3d39d1bf2104bc324249d9f5390be2ab2a240ed02a37fbc8fd978ce514a8697";
        ...
        async function fetchQuestion(token) {
            ...
            const url =
                "https://opentdb.com/api.php?amount=1&type=multiple&token=" +
                token;
        ...
        let newArray = shuffle(
            [].concat(
                response_json.incorrect_answers,
                response_json.correct_answer
            )
        );
